    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'auth' ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('pages.auth.auth-forgot-password') ? 'active' : '' }}">
                        <a href="{{ url('pages.auth.auth-forgot-password') }}">Forgot Password</a>
                    </li>
                    <li class="{{ Request::is('pages.auth.auth-login') ? 'active' : '' }}">
                        <a href="{{ url('pages.auth.auth-login') }}">Login</a>
                    </li>
                    <li class="{{ Request::is('pages.auth.auth-login2') ? 'active' : '' }}">
                        <a class="beep beep-sidebar"
                            href="{{ url('pages.auth.auth-login2') }}">Login 2</a>
                    </li>
                    <li class="{{ Request::is('pages.auth.auth-register') ? 'active' : '' }}">
                        <a href="{{ url('pages.auth.auth-register') }}">Register</a>
                    </li>
                    <li class="{{ Request::is('pages.auth.auth-reset-password') ? 'active' : '' }}">
                        <a href="{{ url('pages.auth.auth-reset-password') }}">Reset Password</a>
                    </li>
                </ul>
            </li>
